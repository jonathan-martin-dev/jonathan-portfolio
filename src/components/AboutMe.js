  ...
  return (
    <div className="bg-gray-100 grid grid-flow-row" id="about">
      <div className="container p-20 mx-auto about-me">
        ...
        <p>
          Hi! I'm Jonathan Martinez, a Front-End Developer based in Ventura
          County, California. I've worked on both E-Commerce and Digital
          Marketing teams to provide better buying experiences for customers. I
          have delivered projects that have provided a growth in overall online
          sales and in some cases, created new opportunities for the business.
        </p>
        <p>
          ...
          has created a new set of problem solving skills.
